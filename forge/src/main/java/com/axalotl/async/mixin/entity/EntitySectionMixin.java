...
import net.minecraft.world.World.entity.EntityAccess;
import net.minecraft.world.World.entity.EntitySection;
import net.minecraft.world.World.entity.Visibility;
